    ...
    const fetchSignals = async () => {
      try {
        ...
        if (typeof signals === "string" && signals.includes("export default")) {
          ...
          try {
            const githubRes = await axios.get("https://api.github.com/users/AyushBhardwaj-AdRuntime");
            const reposRes = await axios.get("https://api.github.com/users/AyushBhardwaj-AdRuntime/repos?per_page=100");
