    ...
    >
      ...
      <div className="text-center pt-8">
        <p className="text-[10px] font-bold text-text/30 uppercase tracking-[0.4em]">
          Direct Channel:{" "}
          <a
            href="mailto:ayushbhardwaj1334@gmail.com"
            className="text-accent hover:text-text transition-colors"
          >
            ayushbhardwaj1334@gmail.com
          </a>
        </p>
      </div>
    </form>
...
const Engage = () => {
  useDocumentSEO({
    title: "Hire Ayush Bhardwaj — Web Engineering & Development",
    description:
            ...
            >
              <div className="p-12 md:p-24 h-full flex flex-col">
                ...
                <div className="mt-24 pt-12 border-t border-black/5 text-center">
                  <div className="text-script text-accent text-4xl mb-4">Ayush.</div>
