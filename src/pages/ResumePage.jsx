...
const ResumePage = () => {
  useDocumentSEO({
    title: "Curriculum Vitae — Ayush Bhardwaj",
    description:
      "A comprehensive record of projects built, technical contributions, and professional experience.",
  });
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_400px] gap-24 items-start">
          ...
          >
            ...
            <div className="flex flex-col gap-4">
              ...
              <a
                href="/Resume.pdf"
                download="Ayush_Bhardwaj_Resume.pdf"
