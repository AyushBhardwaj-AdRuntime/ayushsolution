            ...
            <div className="relative z-10 pb-10 border-t border-white/5 pt-6 flex flex-col gap-4">
              ...
              <div className="flex justify-between items-center text-[9px] font-mono font-bold text-white/30 uppercase tracking-[0.3em]">
                ...
                <div className="flex gap-4">
                  <a href="https://github.com/AyushBhardwaj-AdRuntime" target="_blank" rel="noreferrer" className="hover:text-[#D8F1A0] transition-colors">GH</a>
                  <a href="https://www.linkedin.com/in/ayushbhardwaj-dev/" target="_blank" rel="noreferrer" className="hover:text-[#D8F1A0] transition-colors">LN</a>
                </div>
              </div>
            </div>
          </motion.div>
