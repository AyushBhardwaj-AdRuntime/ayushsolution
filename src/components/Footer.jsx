          ...
          <div className="footer-social-row flex justify-between items-center relative z-10">
             ...
             <div className="flex gap-3">
                {[
                  { 
                    name: 'Github', 
                    url: 'https://github.com/AyushBhardwaj-AdRuntime',
                    icon: (
                  ...
                  { 
                    name: 'LinkedIn', 
                    url: 'https://www.linkedin.com/in/ayushbhardwaj-dev/',
                    icon: (
                      <svg className="w-3.5 h-3.5 fill-current" viewBox="0 0 24 24">
        ...
        <div className="footer-right">
          ...
          <div className="flex flex-row gap-20 md:gap-32 pt-4">
             ...
             <div className="footer-col">
                ...
                <div className="flex flex-col gap-4">
                   <a href="mailto:ayushbhardwaj1334@gmail.com" className="text-base font-bold text-black hover:italic transition-all underline decoration-black/5 underline-offset-4">Email</a>
                   <a href="https://www.linkedin.com/in/ayushbhardwaj-dev/" target="_blank" rel="noreferrer" className="text-base font-bold text-black hover:italic transition-all">LinkedIn</a>
                   <a href="https://github.com/AyushBhardwaj-AdRuntime" target="_blank" rel="noreferrer" className="text-base font-bold text-black hover:italic transition-all">GitHub</a>
                </div>
             </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between mt-20 gap-10">
             <div className="text-[10px] font-black text-black/20 uppercase tracking-[0.3em]">
                &copy; 2026 Ayush Bhardwaj &middot; v1.0
             </div>
