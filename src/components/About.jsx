          ...
          >
            ...
            <div className="space-y-10 max-w-xl about-text">
              <p className="text-lg md:text-xl text-black/20 leading-relaxed font-medium">
                I build things that work well and last. Not just demos or side
                projects — the kind of <strong className="text-black font-extrabold bg-[#D8F1A0]/30 px-1.5 py-0.5 border-b border-black/10">software that people rely on</strong> every
                day without thinking about it.
              </p>
              <p className="text-lg md:text-xl text-black/20 leading-relaxed font-medium">
                I enjoy the <strong className="text-black font-extrabold bg-[#D8F1A0]/30 px-1.5 py-0.5 border-b border-black/10">full development cycle</strong> — from understanding
                requirements to writing clean code, testing edge cases, and
                deploying to production.
              </p>
              <p className="text-lg md:text-xl text-black/20 leading-relaxed font-medium">
                My focus sits at the intersection of engineering and user
                experience. I care about code quality, performance, and
                building interfaces that feel <strong className="text-black font-extrabold bg-[#D8F1A0]/30 px-1.5 py-0.5 border-b border-black/10">fast, intuitive, and reliable</strong>.
              </p>

              <div className="flex gap-8 pt-8">
                <a
                  href="https://github.com/AyushBhardwaj-AdRuntime"
                  target="_blank"
                ...
                <a
                  href="https://www.linkedin.com/in/ayushbhardwaj-dev/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-xs font-bold uppercase tracking-[0.3em] border-b-2 border-black/5 hover:border-black pb-1 transition-all"
                >
