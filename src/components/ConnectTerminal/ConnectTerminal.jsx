...
const ConnectTerminal = () => {
  const [history, setHistory] = useState([
    { type: "output", content: "Ayush Portfolio initialized." },
    ...
    if (e.key === "Enter") {
      ...
      switch (cmd.toLowerCase()) {
        case "help":
          ...
          break;
        case "email":
          response = "Opening mail client... (ayushbhardwaj1334@gmail.com)";
          window.location.href = "mailto:ayushbhardwaj1334@gmail.com";
          break;
        case "github":
          response = "Opening GitHub...";
          window.open("https://github.com/AyushBhardwaj-AdRuntime", "_blank");
          break;
        case "linkedin":
          response = "Opening LinkedIn...";
          window.open(
            "https://www.linkedin.com/in/ayushbhardwaj-dev/",
            "_blank"
          );
          break;
        case "x":
        ...
        case "projects":
          ...
          window.open(
            "https://github.com/AyushBhardwaj-AdRuntime",
            "_blank"
          );
          break;
        case "contact":
          response =
            "Email: ayushbhardwaj1334@gmail.com | GitHub: AyushBhardwaj-AdRuntime";
          break;
        case "clear":
          setHistory([]);
          setInput("");
    ...
    <section className="section-spacing bg-grid/5 border-t border-white/5 font-mono text-sm leading-6">
      <div className="container mx-auto px-6 max-w-4xl">
        ...
        <div className="text-center mt-12 text-gray-600 text-xs">
          &copy; 2026 AYUSH BHARDWAJ. ALL RIGHTS RESERVED.
        </div>
      </div>
    </section>
  );
